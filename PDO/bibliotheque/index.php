...
foreach ($tab as $key => $value) {
    echo "<tr><td>$value[isbn_livre]</td><td>$value[titre_livre]</td><td>$value[nomcomplet_auteur]</td><td>$value[nb_pages] pages</td><td>$value[prix] DHS</td><td><img src='covers/$value[image]' width='70px'></td><td><a href='update.php'><button>modifier</button></a><a href='delete.php'><button>supprimer</button></a></td></tr>" ;
